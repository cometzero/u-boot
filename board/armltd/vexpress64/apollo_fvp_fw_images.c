...
struct efi_fw_image apollo_fvp_fw_images[] = {
	{
		.image_type_id = APOLLO_FVP_TFM_BL2_IMAGE_GUID,
		.fw_name = u"TFM_BL2",
		.image_index = FW_IMAGE_INDEX_BL2,
	},
	{
		.image_type_id = APOLLO_FVP_TFM_RUNTIME_IMAGE_GUID,
		.fw_name = u"TFM_S",
		.image_index = FW_IMAGE_INDEX_TFM_S,
	},
	{
		.image_type_id = APOLLO_FVP_SCP_FIRMWARE_IMAGE_GUID,
		.fw_name = u"SCP",
		.image_index = FW_IMAGE_INDEX_SCP,
	},
	{
		.image_type_id = APOLLO_FVP_AP_FIP_IMAGE_GUID,
		.fw_name = u"TFA_FIP",
		.image_index = FW_IMAGE_INDEX_AP_FIP,
	},
#ifdef APOLLO_FVP_VARIANT_CFG2
	{
		.image_type_id = APOLLO_FVP_SI_CL1_IMAGE_GUID,
		.fw_name = u"SI_CL1",
...
struct efi_capsule_update_info update_info = {
	.dfu_string = NULL,
	.num_images = ARRAY_SIZE(apollo_fvp_fw_images),
	.images = apollo_fvp_fw_images
};
